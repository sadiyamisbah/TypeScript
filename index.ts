...
//object one
let userOne = new Facebook("Sadiya","1994-05-30","female",["VVIET","GSC"],"Mysore",123456789,"life Is Beautiful",["LTI"]);
...
let userTwo = new Facebook("Naziya","1997-05-29","female",["SDM","GSC"],"Mysore",123456989,"Perseverence is the hardwork you do after you get tired of doing the hardwork you already did",["Studying"],userOne);
...
let userThree = new Facebook("Uwaise","1993-01-19","male",["NIE","St. Philos"],"Mysore",1234558800,"Hardwork beats talent when talent doesn't work hard",["QCON","Quality"],userTwo);
